                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-danger text-24 line-height-1 m-0">21</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-danger text-24 line-height-1 m-0">4021</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="card o-hidden mb-4">
                        <div class="card-header">
                            <h3 class="w-50 float-left card-title m-0">Nouvel Utilisateurs</h3>
