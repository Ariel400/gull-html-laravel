                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                  Bonjour {{$fullname}},
                                  <br />
                                  le contrat de credit bail de Mr/Mme <span>{{$nom_clt}}</span>&nbsp; <span th:text="${prenom}"></span> vous à été attribuer 
                                  <br />
                                  Merci de vous connecter pour Avoir plus de détail
                                </div>
                              </td>
                            </tr>
                          </table>
                                              ...
                                              <td width='33%'>
                                                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:collapse;border-spacing:0px;'>
                                                  <tbody>
                                                    <tr>
                                                      <td style='width:100px;'>
                                                        <img alt='step 2' height='auto' src='https://assets.opensourceemails.com/imgs/oxygen/YL3H3V5bRyGuy6pess9T_v33_04.jpg' style='border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='100' />
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                              ...
                                              <td width='33%'>
                                                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:collapse;border-spacing:0px;'>
                                                  <tbody>
                                                    <tr>
                                                      <td style='width:100px;'>
                                                        <img alt='step 3 highlighted' height='auto' src='https://assets.opensourceemails.com/imgs/oxygen/YSTlgtgaTSa897tPTUhl_v3_05.jpg' style='border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='100' />
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
