...
<div style="background-color:#f5fcff;">
    <!--[if mso | IE]>
    <table
            align="center" border="0" cellpadding="0" cellspacing="0" class="mt-25-outlook" style="width:600px;"
            width="600"
    >
    <tr>
    ...
    <![endif]-->
    <div class="mt-25"
         style="background: #ffffff; background-color: #ffffff; margin: 0px auto; max-width: 600px; margin-top: 55px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        @if(isset($lien) && !empty($lien))
                                            <tr>
                                                ...
                                                <td align="center" bgcolor="#007aff" role="presentation"
                                                    style="border:none;border-radius:24px;cursor:auto;mso-padding-alt:10px 25px;background:#007aff;"
                                                    valign="middle"><a
                                                            href="{{ (isset($lien) && !empty($lien))?$lien:'' }}"
                                                            style="display:inline-block;background:#007aff;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:24px;"
                                                            target="_blank">
                                                        {{$nom_lien ?? ''}}
                                                    </a></td>
                                            </tr>
