...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <link rel="apple-touch-icon" sizes="57x57" href="assets2/images/favicons/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="assets2/images/favicons/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="assets2/images/favicons/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="assets2/images/favicons/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="assets2/images/favicons/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="assets2/images/favicons/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="assets2/images/favicons/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="assets2/images/favicons/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="assets2/images/favicons/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="assets2/images/favicons/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets2/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="assets2/images/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets2/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="assets2/images/favicons/ms-icon-144x144.png">
    ...
    -->
    <!-- Default stylesheets-->
    <link href="assets2/lib/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Template specific stylesheets-->
    <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Volkhov:400i" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">
    <link href="assets2/lib/animate.css/animate.css" rel="stylesheet">
    <link href="assets2/lib/components-font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="assets2/lib/et-line-font/et-line-font.css" rel="stylesheet">
    <link href="assets2/lib/flexslider/flexslider.css" rel="stylesheet">
    <link href="assets2/lib/owl.carousel/dist/assets2/owl.carousel.min.css" rel="stylesheet">
    <link href="assets2/lib/owl.carousel/dist/assets2/owl.theme.default.min.css" rel="stylesheet">
    <link href="assets2/lib/magnific-popup/dist/magnific-popup.css" rel="stylesheet">
    <link href="assets2/lib/simple-text-rotator/simpletextrotator.css" rel="stylesheet">
    <!-- Main stylesheet and color file-->
    <link href="assets2/css/style.css" rel="stylesheet">
    <link id="color-scheme" href="assets2/css/colors/default.css" rel="stylesheet">
  </head>
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.html">Credit Access</a>
          </div>
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <!--                .navbar-cart-img-->
              <!--                    a(href='#')-->
              <!--                        img(src='assets2/images/shop/product-9.jpg', alt='')-->
              <!--                .navbar-cart-title-->
              ...
              <!--                .navbar-cart-img-->
              <!--                    a(href='#')-->
              <!--                        img(src='assets2/images/shop/product-10.jpg', alt='')-->
              <!--                .navbar-cart-title-->
      ...
      <section class="home-section home-parallax home-fade home-full-height bg-dark-60 agency-page-header" id="home" data-background="assets2/images/agency/agency_bg.jpg">
      ...
      <div class="main">
        ...
        <section class="module pt-0 pb-0" id="about">
          <div class="row position-relative m-0">
            <div class="col-xs-12 col-md-6 side-image" data-background="assets2/images/section-14.jpg"></div>
          ...
          <div class="container">
            ...
            <ul class="works-grid works-grid-gut works-grid-3 works-hover-d" id="works-grid">
              <li class="work-item illustration webdesign"><a href="portfolio_single_featured_image1.html">
                  <div class="work-image"><img src="assets2/images/portfolio/grid-portfolio1.jpg" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
                    <h3 class="work-title">Corporate Identity</h3>
                    <div class="work-descr">Illustration</div>
                  </div></a></li>
              <li class="work-item marketing photography"><a href="portfolio_single_featured_image2.html">
                  <div class="work-image"><img src="assets2/images/portfolio/grid-portfolio2.jpg" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
                    <h3 class="work-title">Bag MockUp</h3>
                    <div class="work-descr">Marketing</div>
                  </div></a></li>
              <li class="work-item illustration photography"><a href="portfolio_single_featured_slider1.html">
                  <div class="work-image"><img src="assets2/images/portfolio/grid-portfolio3.jpg" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
                    <h3 class="work-title">Disk Cover</h3>
                    <div class="work-descr">Illustration</div>
                  </div></a></li>
              <li class="work-item marketing photography"><a href="portfolio_single_featured_slider2.htmll">
                  <div class="work-image"><img src="assets2/images/portfolio/grid-portfolio4.jpg" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
              ...
              <li class="work-item illustration webdesign"><a href="portfolio_single_featured_video1.html">
                  <div class="work-image"><img src="assets2/images/portfolio/grid-portfolio5.jpg" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
              ...
              <li class="work-item marketing webdesign"><a href="portfolio_single_featured_video2.html">
                  <div class="work-image"><img src="assets2/images/portfolio/grid-portfolio6.jpg" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="mb-sm-20 wow fadeInUp col-md-4 col-sm-6 col-xs-12" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="assets2/images/team-1.jpg" alt="Member Photo"/>
              ...
              <div class="mb-sm-20 wow fadeInUp col-md-4 col-sm-6 col-xs-12" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="assets2/images/team-2.jpg" alt="Member Photo"/>
                    <div class="team-detail">
              ...
              <div class="mb-sm-20 wow fadeInUp col-md-4 col-sm-6 col-xs-12" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="assets2/images/team-4.jpg" alt="Member Photo"/>
                    <div class="team-detail">
        ...
        <section class="module bg-dark-60 pt-0 pb-0 parallax-bg testimonial" data-background="assets2/images/testimonial_bg.jpg">
              ...
              <div class="col-sm-3">
                <div class="widget">
                  ...
                  <ul class="widget-posts">
                    <li class="clearfix">
                      <div class="widget-posts-image"><a href="#"><img src="assets2/images/rp-1.jpg" alt="Post Thumbnail"/></a></div>
                    ...
                    <li class="clearfix">
                      <div class="widget-posts-image"><a href="#"><img src="assets2/images/rp-2.jpg" alt="Post Thumbnail"/></a></div>
                      <div class="widget-posts-body">
    ...
    =============================================
    -->
    <script src="assets2/lib/jquery/dist/jquery.js"></script>
    <script src="assets2/lib/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="assets2/lib/wow/dist/wow.js"></script>
    <script src="assets2/lib/jquery.mb.ytplayer/dist/jquery.mb.YTPlayer.js"></script>
    <script src="assets2/lib/isotope/dist/isotope.pkgd.js"></script>
    <script src="assets2/lib/imagesloaded/imagesloaded.pkgd.js"></script>
    <script src="assets2/lib/flexslider/jquery.flexslider.js"></script>
    <script src="assets2/lib/owl.carousel/dist/owl.carousel.min.js"></script>
    <script src="assets2/lib/smoothscroll.js"></script>
    <script src="assets2/lib/magnific-popup/dist/jquery.magnific-popup.js"></script>
    <script src="assets2/lib/simple-text-rotator/jquery.simple-text-rotator.min.js"></script>
